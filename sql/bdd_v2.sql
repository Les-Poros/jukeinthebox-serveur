...
--
-- Client :  localhost
-- Généré le :  Mar 12 Février 2019 à 13:37
...
INSERT INTO `bibliotheque` (`idBibliotheque`, `idPiste`) VALUES
(1, 1);
...
INSERT INTO `jukebox` (`idJukebox`, `idBibliotheque`, `tokenActivation`, `estActive`, `qr_code`) VALUES
(1, 1, 'token', 1, 'qrcode');
-- --------------------------------------------------------
...
ALTER TABLE `bibliotheque`
  ADD CONSTRAINT `bibliotheque_ibfk_1` FOREIGN KEY (`idPiste`) REFERENCES `piste` (`idPiste`);
